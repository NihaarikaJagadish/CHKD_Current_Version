...
class _procedureState extends State<procedure> {
  ...
  void initState() {
    ...
    print("Inside");
    print(surgeryName);
    print(surgeryVariable.surgeryDetails);
    _initPDF();
  }
...
//                    .surgeryDetails[surgeryName]['procedure'].length),
//                itemBuilder: (
//                  BuildContext ctxt,
//                  int index,
//                ) {
...
//              ),
                    ...
                    Text(
                      surgeryVariable.surgeryDetails[surgeryName]["procedure"]
                              [0][0] +
                          "\n",
                      textAlign: TextAlign.center,
                      style: TextStyle(
  ...
  _addCard(BuildContext ctxt, int index, String s) {
    print(s);
    var c = surgeryVariable.surgeryDetails[s]['procedure'][0][1];
