...
class homeCareTab extends StatefulWidget {
  @override
  _homeCareTabState createState() => _homeCareTabState();
}
...
//            ),
                  ...
                  children: [
                    ListView.builder(
                      ...
                      itemCount: (surgeryVariable
                          .surgeryDetails[surgeryName]['home care'].length),
                      itemBuilder: (
                        BuildContext ctxt,
                        int index,
                      ) {
  ...
  _addCard(BuildContext ctxt, int index, String s) {
    print(s);
    var head = surgeryVariable.surgeryDetails[s]['home care'][index][0];
    var c = surgeryVariable.surgeryDetails[s]['home care'][index][1];
